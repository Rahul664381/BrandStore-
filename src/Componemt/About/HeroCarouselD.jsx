    ...
    >
      ...
      <div className="carousel-inner">
        ...
        <div className="carousel-item" data-bs-interval="4000">
          <img
            src="https://images.pexels.com/photos/10689371/pexels-photo-10689371.jpeg"
            className="d-block w-100"
            alt="Fashion Banner"
          />
          <div className="carousel-caption text-center">
        ...
        <div className="carousel-item" data-bs-interval="4000">
          <img
            src="https://images.pexels.com/photos/8386646/pexels-photo-8386646.jpeg"
            className="d-block w-100"
            alt="Store Banner"
          />
          <div className="carousel-caption text-center">
